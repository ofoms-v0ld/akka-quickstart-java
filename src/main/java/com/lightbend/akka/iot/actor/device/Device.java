...
public class Device extends AbstractBehavior<Device.Command> {
  ...
  /**
  *  Добавляем в ReceiveBuilder методы которые будем обрабатывать при получении сообщения actor'ом 
  */
  @Override
 ...
 /**
 * Обработка полученного сообщения по OnMessage.
 * Формирование/отправка ответа путем запроса ReadTemperature#replyTo#tell(new RespondTemperature(r.requestId, lastTemperatureReading))
 * @param r
 * @return
 */
